...
--
-- Name: projects; Type: TABLE; Schema: public; Owner: daven
--
...
CREATE TABLE public.projects (
    ...
    start date,
    completion date,
    CONSTRAINT projects_difficulty_check CHECK (((difficulty >= 1) AND (difficulty <= 5)))
);


ALTER TABLE public.projects OWNER TO daven;

--
-- Name: projects_index_seq; Type: SEQUENCE; Schema: public; Owner: daven
--

CREATE SEQUENCE public.projects_index_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.projects_index_seq OWNER TO daven;

--
-- Name: projects_index_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: daven
--

ALTER SEQUENCE public.projects_index_seq OWNED BY public.projects.index;
...
--
-- Name: projects index; Type: DEFAULT; Schema: public; Owner: daven
--

ALTER TABLE ONLY public.projects ALTER COLUMN index SET DEFAULT nextval('public.projects_index_seq'::regclass);
...
--
-- Name: projects projects_pkey; Type: CONSTRAINT; Schema: public; Owner: daven
--

ALTER TABLE ONLY public.projects
    ADD CONSTRAINT projects_pkey PRIMARY KEY (index);
...
--
-- Name: basic_projects fk_basic_projects_projects; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.basic_projects
    ADD CONSTRAINT fk_basic_projects_projects FOREIGN KEY (index) REFERENCES public.projects(index);


--
-- Name: complex_projects fk_complex_project_project_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.complex_projects
    ADD CONSTRAINT fk_complex_project_project_id FOREIGN KEY (project_id) REFERENCES public.projects(index);
